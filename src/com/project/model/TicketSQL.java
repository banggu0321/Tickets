...
public class TicketSQL {
	...
	static final String SQL_TICKET_SELECT_PER = 
					...
					+ " WHERE t.WISH_NO = ?";
	static final String SQL_TICKET_UPDATE_SEAT = "UPDATE PERFORMANCE SET PER_SEAT = PER_SEAT-1 WHERE PER_NO = ?";//���ƾƾƾ�
	...
	static final String SQL_SELECT_WISHNO_TICNO = "SELECT WISH_NO FROM TICKET WHERE TIC_NO = ?";
	static final String SQL_UPDATE_DEL_TICKET_WISH = "UPDATE WISHLIST SET WISH_SEE = 'N' WHERE WISH_NO = ?";
