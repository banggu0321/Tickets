...
INSERT INTO PERFORMANCE VALUES(seq_perno.nextval,'마타하리','샤롯데씨어터',to_date('2022-06-01 14:00','yyyy-mm-dd hh24:mi'),'180분','150,000원','옥주현','뮤지컬','10');
...
INSERT INTO PERFORMANCE VALUES(seq_perno.nextval,'쉬어매드니스','서울 대학로',to_date('2022-05-31 15:00','yyyy-mm-dd hh24:mi'),'110분','35,000원','허욱','연극','10');
...
--DELETE FROM TICKET t WHERE TIC_NO = 3;
SELECT WISH_NO FROM TICKET WHERE TIC_NO = 7;
--=====main페이지==========================================
--(1~5)
		--@@작업을 선택하세요>>
--1. 회원가입
INSERT INTO MEMBER VALUES('id','pw','방근영','qwer@gmail.com','010-1234-5678');
